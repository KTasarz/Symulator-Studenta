    ...
    menu:
        ...
        "Odpocząć na ławce":
            ...
            if event_random == 1:
                ...
                "To dziki!{p}Chyba lepiej z stąd znikać!"
                play sound "audio/Boar chrum.mp3"
                "W sumie to nigdy nie widziałeś żeby dziki zrobiłe jakąś krzywde ludziom{p}Może jednak warto zostać i spróbować się z nimi zaprzyjaźnić?"
                ...
                menu:
                    ...
                    "Spróbuj je pogłaskać":
                        ...
                        if event_random == 1:
                            ...
                            "Ostatnie co pamiętasz to szarżujący dzik w twoją strone"
                            $ add_hour(renpy.random.randint(2, 4))
                            $ stress = stress + 10
                            "Wstajesz z ziemi lekko obity, na szczęście nic poważnego ci się nie stało"
            else:
                #Bez Eventów
                "Odpocząłeś chwilę na ławce"
            $ check_stats_surplus()
                ...
                if hour >= 20 or hour <= 4:
                    ...
                    menu:
                        ...
                        "Faworka(5 zł)"if money >= 5:
                            ...
                            "Kiedy podnosisz głowe by pożegnać się z sprzedawcą, go już niema, zupełnie jakby się rozpłynął"
                        ...
                        "Książka \"Użycie swojej w wiedzy w praktyce! Wydanie dla osób z niskim IQ!\"(100zł)" if money >= 100:
                            ...
                            "Spoglądasz na tą cegłe i zastanawiasz czy nie popełniłeś błędu"
                            "Kiedy podnosisz głowe by pożegnać się z sprzedawcą, go już niema, zupełnie jakby się rozpłynął"
                            "Postanawiasz przeczytać tą cegłe{p}Okazuje że wiekszość stron to obrazki z przykładami!{p}Bardzo szybką ją przeczytałeś i czujesz jak masz więcej umiętejntności!"
                            $ skills = skills + 50
                    ...
                    h "Panie kierowniku proszę poratuj mnie złotówką!"
                    menu:
                        ...
                        "Daj mu złotówke" if money > 0:
                            ...
                            "Tak szybko jak się pojawił bezdommy, tak samo zniknął{w} Kontynuowałeś swoje bieganie bez większych problemów"
                            $ sleep = sleep - 2;
                        ...
                        "Spróbuj go spławić":
                            ...
                            if event_random == 1:
                                ...
                                h "No panie kierowniku nie bądź taki, proszę jedynie o złotówkę"
